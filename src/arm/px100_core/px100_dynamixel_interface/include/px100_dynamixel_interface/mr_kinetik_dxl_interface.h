#ifndef MR_KINETIK_DXL_INTERFACE_H_
#define MR_KINETIK_DXL_INTERFACE_H_
...
#include "px100_dynamixel_interface/Reboot.h"
#include "px100_dynamixel_interface/RobotInfo.h"
#include "px100_dynamixel_interface/MotorGains.h"
#include "px100_dynamixel_interface/TorqueEnable.h"
#include "px100_dynamixel_interface/OperatingModes.h"
#include "px100_dynamixel_interface/RegisterValues.h"
#include "px100_dynamixel_interface/JointGroupCommand.h"
#include "px100_dynamixel_interface/JointSingleCommand.h"
#include "px100_dynamixel_interface/JointTrajectoryCommand.h"
...
struct Gripper                                                          // Struct to hold data gripper
{
...
class MrKinetikDXLInterface
{
public:

  /// @brief Constructor for the MrKinetikDXLInterface
  /// @param node_handle - ROS NodeHandle
  /// @param success [out] - bool indicating if the node launched successfully
  explicit MrKinetikDXLInterface(ros::NodeHandle *node_handle, bool &success);

  /// @brief Destructor for the MrKinetikDXLInterface
  ~MrKinetikDXLInterface();
...
private:
  ...
  px100_dynamixel_interface::JointTrajectoryCommand joint_traj_cmd;                     // Holds the most recent JointTrajectoryCommand message
  ...
  void robot_sub_command_group(const px100_dynamixel_interface::JointGroupCommand &msg);
  ...
  /// @details - refer to the message definition for details
  void robot_sub_command_single(const px100_dynamixel_interface::JointSingleCommand &msg);
  ...
  /// @details - refer to the message definition for details
  void robot_sub_command_traj(const px100_dynamixel_interface::JointTrajectoryCommand &msg);
  ...
  bool robot_srv_torque_enable(px100_dynamixel_interface::TorqueEnable::Request &req, px100_dynamixel_interface::TorqueEnable::Response &res);
  ...
  /// @details - refer to the service definition for details
  bool robot_srv_reboot_motors(px100_dynamixel_interface::Reboot::Request &req, px100_dynamixel_interface::Reboot::Response &res);
  ...
  /// @details - refer to the service definition for details
  bool robot_srv_get_robot_info(px100_dynamixel_interface::RobotInfo::Request &req, px100_dynamixel_interface::RobotInfo::Response &res);
  ...
  /// @details - refer to the service definition for details
  bool robot_srv_set_operating_modes(px100_dynamixel_interface::OperatingModes::Request &req, px100_dynamixel_interface::OperatingModes::Response &res);
  ...
  bool robot_srv_set_motor_pid_gains(px100_dynamixel_interface::MotorGains::Request &req, px100_dynamixel_interface::MotorGains::Response &res);
  ...
  /// @details - refer to the service definition for details
  bool robot_srv_set_motor_registers(px100_dynamixel_interface::RegisterValues::Request &req, px100_dynamixel_interface::RegisterValues::Response &res);
  ...
  /// @details - refer to the service definition for details
  bool robot_srv_get_motor_registers(px100_dynamixel_interface::RegisterValues::Request &req, px100_dynamixel_interface::RegisterValues::Response &res);
